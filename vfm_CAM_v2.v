...
module vfm_CAM_v2 
#(
parameter addr_width = 4  , // {set,group} field width
parameter data_width = 9 // tag field width  // this is 3 instead of 7 to speed up compilation
)
(
input                        Clock        , // Used for syncronous write
input                        Resetn       , // Syncronous reset
input                        WR           , // Write-Enable
input  [addr_width-1    : 0] Write_Addr   , // "{Set,Group}" to write incoming "TAG or Block" to
...
output [2**addr_width-1 : 0] CAM_Out      , // "{Set,Group}" where tag was found encoded in one-hot
output [data_width-1    : 0] ADDR_Out       // "TAG or Block" stored at "{Set,Group}"
);
