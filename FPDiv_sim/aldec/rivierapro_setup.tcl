...
# ACDS 18.1 625 win32 2024.02.06.14:51:19
# ----------------------------------------
...
# ----------------------------------------
# If FPDiv is one of several IP cores in your
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/FPDiv_memoryC0_uid112_invTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/FPDiv_memoryC1_uid115_invTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FPDiv.vo"
}
